...
NSString *const MJRefreshHeaderIdleText = @"下拉开始刷新";
...
NSString *const MJRefreshAutoFooterRefreshingText = @"正在加载数据...";
...
NSString *const MJRefreshBackFooterRefreshingText = @"正在加载数据...";
