...
+(void)show : (UIViewController *)controller
       title: (NSString *)title
        ...
        mine:(BOOL)isMine
{
    VoteListViewController *openViewControler = [[VoteListViewController alloc]init];
...
-(void)requestList : (BOOL)isLoadMore
{
    ...
    params[@"cid"] = [NSString stringWithFormat:@"%d", (int)[userDefault integerForKey:VillageID]];
